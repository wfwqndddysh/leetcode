...
public:
            ...
            , std::unordered_set<std::string>& wordDict)
    {
        ...
        if(wordDict.count(beginWord)==0 || wordDict.count(endWord)==0) return 0;
